...
public abstract class UpgradeProcess
	 ...
	 *          #alterColumnName(Connection, String, String, String)}
	 */
	@Deprecated
	...
	/**
	 *   @deprecated As of Cavanaugh (7.4.x), replaced by {@link
	 *          #alterColumnType(Connection, String, String, String)}
	 */
	@Deprecated
	...
	/**
	 *   @deprecated As of Cavanaugh (7.4.x), replaced by {@link
	 *          #alterTableAddColumn(Connection, String, String, String)}
	 */
	@Deprecated
	...
	/**
	 *   @deprecated As of Cavanaugh (7.4.x), replaced by {@link
	 *          #alterTableDropColumn(Connection, String, String)}
	 */
	@Deprecated
			...
			for (Alterable alterable : alterables) {
				if (alterable instanceof AlterColumnName) {
					...
					alterColumnName(
						...
						alterColumnName.getOldColumnName(),
					...
					alterColumnType(
						connection, tableName, alterColumnType.getColumnName(),
					...
					alterTableAddColumn(
						connection, tableName,
						alterTableAddColumn.getColumnName(),
					...
					alterTableDropColumn(
						connection, tableName,
						alterTableDropColumn.getColumnName());
				}
			}
		}
	}
