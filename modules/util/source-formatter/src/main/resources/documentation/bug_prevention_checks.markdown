...
JavaCompanyThreadLocalSetCompanyIdCallCheck | .java | Finds cases where `CompanyThreadLocal.setCompanyId` is used (instead of `CompanyThreadLocal.setCompanyIdWithSafeCloseable`). |
