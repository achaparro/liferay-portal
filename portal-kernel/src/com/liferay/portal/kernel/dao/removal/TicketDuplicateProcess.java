...
public class TicketDuplicateProcess extends BaseDuplicateProcess {
	...
	public void doUpgrade() throws SQLException {
		String[][] ticketUniqueIndexes = {
			{"IX_123465", "_key"}, {"IX_4252345", "column1,column2,column3"}
		};// for cases when there are more than one unique index
		...
		for (String[] uniqueIndex : ticketUniqueIndexes) {
			...
			for (HashMap<String, String> ticketDuplicate :
					ticketDuplicatesList) {
