...
package com.liferay.portal.db.partitioning.internal;
 ...
 */
@Component(immediate = true, service = DBPartitioning.class)
public class DBPartitioningImpl implements DBPartitioning {
	...
	public void validate() throws Exception {
		...
		if (db.getDBType() != DBType.MYSQL) {
			throw new RuntimeException("Database Partitioning requires MySQL");
		}
	}
