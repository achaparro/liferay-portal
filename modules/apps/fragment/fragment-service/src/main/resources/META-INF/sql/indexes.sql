create unique index IX_D55B34DD on FragmentCollection (groupId, fragmentCollectionKey[$COLUMN_LENGTH:75$], companyId);
...
create unique index IX_B91D6AFE on FragmentCollection (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);
...
create unique index IX_C91CD795 on FragmentEntry (groupId, fragmentEntryKey[$COLUMN_LENGTH:75$], companyId);
create index IX_C65BF31C on FragmentEntry (uuid_[$COLUMN_LENGTH:75$], companyId);
create unique index IX_222584CA on FragmentEntry (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);
...
create unique index IX_4F9C6FF0 on FragmentEntryLink (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);