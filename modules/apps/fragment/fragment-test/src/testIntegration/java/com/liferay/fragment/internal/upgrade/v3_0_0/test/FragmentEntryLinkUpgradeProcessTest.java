		...
		try (Connection connection = DataAccess.getConnection();
			PreparedStatement preparedStatement = connection.prepareStatement(
				StringBundler.concat(
					...
					"FragmentEntry.fragmentEntryId from FragmentEntryLink ",
					"FragmentEntryLink1 left join Group_ on ",
					"Group_.externalReferenceCode = ",
					"FragmentEntryLink1.fragmentEntryScopeERC or ( ",
					"Group_.groupId = FragmentEntryLink1.groupId and ",
					"FragmentEntryLink1.fragmentEntryScopeERC is null) left ",
					"join FragmentEntry on ",
					"FragmentEntry.externalReferenceCode = ",
					"FragmentEntryLink1.fragmentEntryERC and ",
					"FragmentEntry.groupId = Group_.groupId left join ",
					"FragmentEntryLink FragmentEntryLink2 on ",
					"FragmentEntryLink1.originalFragmentEntryLinkERC = ",
					"FragmentEntryLink2.externalReferenceCode and ",
					"FragmentEntryLink1.fragmentEntryERC = ",
			...
			while (resultSet.next()) {
				...
				long fragmentEntryLinkId = resultSet.getLong(2);
				long originalFragmentEntryLinkId = resultSet.getLong(3);
				long fragmentEntryId = resultSet.getLong(4);
				...
				_db.runSQL(
					StringBundler.concat(
						...
						fragmentEntryId, " where fragmentEntryLinkId = ",
						fragmentEntryLinkId, " and ctCollectionId = ",
						ctCollectionId));
			}
		}
