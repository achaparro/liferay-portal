...
public class AssetEntryAssetCategoryRelLocalServiceImpl
	...
	public long[] getAssetCategoryPrimaryKeys(long entryId) {
		...
		for (int i = 0; i < assetEntryAssetCategoryRelList.size(); i++) {
			AssetEntryAssetCategoryRel assetEntryAssetCategoryRel = assetEntryAssetCategoryRelList.get(i);

			assetCategoryPrimaryKeys[i] = assetEntryAssetCategoryRel.getAssetCategoryId();
		}
	...
	public long[] getAssetEntryPrimaryKeys(long categoryId) {
		...
		for (int i = 0; i < assetEntryAssetCategoryRelList.size(); i++) {
			...
			assetEntryPrimaryKeys[i] = assetEntryAssetCategoryRel.getAssetCategoryId();
		}
