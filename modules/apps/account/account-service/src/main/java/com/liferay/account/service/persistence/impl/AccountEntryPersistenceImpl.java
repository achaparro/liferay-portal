...
public class AccountEntryPersistenceImpl
	...
	public AccountEntry[] findByCompanyId_PrevAndNext(
		...
		AccountEntry accountEntry = findByPrimaryKey(accountEntryPK);
	...
	public AccountEntryPersistenceImpl() {
		...
		setModelPKClass(AccountEntryPK.class);
	}
	...
	public AccountEntry create(AccountEntryPK accountEntryPK) {
		...
		accountEntry.setPrimaryKey(accountEntryPK);
	...
	public AccountEntry remove(AccountEntryPK accountEntryPK)
		...
		return remove((Serializable)accountEntryPK);
	}
	...
	public AccountEntry findByPrimaryKey(AccountEntryPK accountEntryPK)
		...
		return findByPrimaryKey((Serializable)accountEntryPK);
	}
	...
	public AccountEntry fetchByPrimaryKey(AccountEntryPK accountEntryPK) {
		return fetchByPrimaryKey((Serializable)accountEntryPK);
	}
	...
	private static final Set<String> _compoundPKColumnNames = SetUtil.fromArray(
		new String[] {"accountEntryId", "companyId"});
