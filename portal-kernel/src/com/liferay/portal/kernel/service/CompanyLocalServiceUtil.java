...
public class CompanyLocalServiceUtil {
	...
	public static <T, E extends Exception> java.util.stream.Stream<T>
		applyForEachCompanyId(
			com.liferay.petra.function.UnsafeFunction<Long, T, E>
				unsafeFunction,
			java.util.function.BiConsumer<Long, E> biConsumer,
			java.util.stream.Stream<Long> companyIdsStream) {

		return getService().applyForEachCompanyId(
			unsafeFunction, biConsumer, companyIdsStream);
	}
