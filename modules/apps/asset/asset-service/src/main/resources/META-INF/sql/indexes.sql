create unique index IX_247596D6 on AssetEntryUsage (assetEntryId, containerType, containerKey[$COLUMN_LENGTH:200$], plid, companyId);
...
create unique index IX_1DD2068D on AssetEntryUsage (uuid_[$COLUMN_LENGTH:75$], groupId, companyId);