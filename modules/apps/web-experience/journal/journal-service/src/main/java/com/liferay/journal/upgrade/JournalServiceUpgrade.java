...
import com.liferay.journal.internal.upgrade.v1_0_3.UpgradeJournalArticleTreePath;
...
public class JournalServiceUpgrade implements UpgradeStepRegistrator {
	...
	public void register(Registry registry) {
		...
		registry.register(
			"com.liferay.journal.service", "1.0.2", "1.0.3",
			new UpgradeJournalArticleTreePath());

		registry.register(
			"com.liferay.journal.service", "1.0.3", "1.1.0",
