...
JavaCompanyThreadLocalSetCompanyIdCallCheck | [Bug Prevention](bug_prevention_checks.markdown#bug-prevention-checks) | Finds cases where `CompanyThreadLocal.setCompanyId` is used (instead of `CompanyThreadLocal.setCompanyIdWithSafeCloseable`). |
