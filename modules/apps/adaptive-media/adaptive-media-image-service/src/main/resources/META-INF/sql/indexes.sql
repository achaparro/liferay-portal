...
create index IX_BDB49A3B on AMImageEntry (uuid_[$COLUMN_LENGTH:200$], companyId, ctCollectionId);
create index IX_668A85C9 on AMImageEntry (uuid_[$COLUMN_LENGTH:200$], ctCollectionId);
create unique index IX_681D2FFD on AMImageEntry (uuid_[$COLUMN_LENGTH:200$], groupId, ctCollectionId);