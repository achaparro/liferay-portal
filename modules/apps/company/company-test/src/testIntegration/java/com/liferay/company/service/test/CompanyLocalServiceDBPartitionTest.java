...
public class CompanyLocalServiceDBPartitionTest
	...
	public void testDeleteCompany() throws Exception {
		...
		Collection<ServiceReference<Portlet>> serviceReferences =
			bundleContext.getServiceReferences(
				Portlet.class,
				"(com.liferay.portlet.company=" + companyId + ")");
	...
	private void _createRepositories(long companyId) throws Exception {
		BundleContext bundleContext = SystemBundleUtil.getBundleContext();
		...
		try (SafeCloseable safeCloseable =
			...
			User adminUser = UserTestUtil.getAdminUser(companyId);
